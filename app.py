...
def set_security_headers(response):
    ...
    response.headers['Content-Security-Policy'] = "default-src 'self'; script-src 'self' 'unsafe-inline' https://unpkg.com https://cdnjs.cloudflare.com; style-src 'self' 'unsafe-inline' https://cdn.lineicons.com; font-src 'self' https://cdn.lineicons.com; connect-src 'self'"
    return response
